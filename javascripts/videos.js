 ...
 * play the video.  To bind videos to this view during development, follow these steps:
 ...
 *
 * Read <a href="http://docs.brightcove.com/en/app-cloud-beta/creating-and-managing-feeds" target="_blank">Creating and manageing feeds</a>.
 *
...
var videosView = ( function( $, undefined) {
  var _waitingToRefresh = false,
      ...
      _embedCode,
      DEFAULT_PLAYER_URL = "http://link.brightcove.com/services/player/bcpid835199013001?bckey=AQ~~,AAAAwnfEsvk~,KAoXD_LRPPB5swx0MfLg05G8agjxyQ1V"
      MESSAGE_TO_SHOW_USER_FOR_PLAYER_INPUT_FIELD = "Paste your Brightcove player URL here.";
  ...
  videosView.prototype.handlePageContainer = function() {
    ...
    pageContainerHTML = "<div class='page list-of-playlists'>" +
                          this.headerHTML( { "title": "Playlists", "backButton": bc.context.moreNavigationView } ) +
                          "<div class='scroller'>" +
                        ...
                        "<div class='page list-of-videos'>" +
                          this.headerHTML( { "title": "Videos", "backButton": true } ) +
                          "<div class='scroller'>" +
                            "<ul class='ul-listview'>" +
                            "</ul>" +
                          "</div>" +
                        ...
                        "<div class='page video-details'>" +
                          this.headerHTML( { "title": "Playlists", "backButton": true } ) +
                          "<div class='scroller'>" +
                            "<div>" +
                            "</div>" +
                          "</div>" +
    ...
    this.element.html( pageContainerHTML );
  };
  ...
  videosView.prototype.buildListOfVideos = function( playlist, firstPage ) {
    var html = ""
      , showBackButton
      , $listOfVideosPage = $( ".list-of-videos" );
    ...
    $listOfVideosPage.find( ".ul-listview" ).html( this.listOfVideosHTML( playlist.videos ) );
   ...
   * @param videos An array of video data objects that is used to generate the HTML string.  The 
   * video object is expected to have the following values.
   * <pre> 
   { 
    "id": "unique_id",
  ...
  videosView.prototype.buildVideoDetail = function( video ) {
    ...
    if( bc.metrics !== undefined ) {
      this.videoViewingEventCallback = bc.metrics.live( "content"
 ...
 videosView.prototype.handleViewBlur = function( evt ) {
   ...
   * @param options An object that represents the settings that can be overridden for this HTML snippet.  Below are the default values.
   <pre>
   {
     ...
     "refreshButton": false, //A boolean for whehter or not to show a refresh button.
     "title": ""
   }
   </pre>
  ...
  videosView.prototype.headerHTML = function( options ) {
    ...
    return ( html += "</header><div class='drop-shadow'></div>" );        
  };
